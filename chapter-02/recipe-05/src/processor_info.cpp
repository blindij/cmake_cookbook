...
int main(){
    ...
    std::cout << "Total physcial memory in megabytes: "
    ...
    std::cout << "Processor has floating point unit: "
                << HAS_FPU << std::endl;
    std::cout << "Processsor supports MMX instructions: "
                << HAS_MMX << std::endl;
    ...
    std::cout << "Processor supports SSE FP instructions: "
                << HAS_SSE_FP  << std::endl;
    std::cout << "Processor support SSE MMX instructions: "
                << HAS_SSE_MMX << std::endl;
    std::cout << "Processor support 3DNow instructions: "
                << HAS_AMD_3DNOW << std::endl;
    std::cout << "Processor supports 3DNow+ instructions: "
                << HAS_AMD_3DNOW_PLUS << std::endl;
    std::cout << "IA64 processor emulationg x86 : "
                << HAS_IA64 << std::endl;
